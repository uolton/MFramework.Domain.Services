...
namespace MFramework.Domain.Services.Repository
{
        ...
        where TEntity : Entity<TEntity>,new()
    {
        ...
        public virtual T UnitOfWork<T>() where T : Transactions.IUnitOfWork
        {
        ...
        {
            return _rootRootRepository.Get(id);
        }

        public IList<TEntity> GetAll()
        {
            return _rootRootRepository.GetAll();
        }

        public IEnumerable<TEntity> Select(Expression<Func<TEntity, bool>> whereClause = null, IOrderByClause<TEntity>[] orderBy = null, int skip = 0, int top = 0,
            string[] include = null)
        {
            return _rootRootRepository.Select(whereClause, orderBy, skip, top, include);
        }
    }
}
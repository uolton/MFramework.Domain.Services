...
namespace MFramework.Domain.Services.Repository.InMemory
{
    /// <summary>
        ...
        where TEntity : Entity<TEntity>,new()
    {
        ...
        {
            return _internal.First(entity => entity.Id==id);
        }

        public override IList<TEntity> GetAll()
        {
            List<TEntity> result = new List<TEntity>();
            _internal.Copy(result);
            return result;
        }
        ...
        public override IEnumerable<TEntity> Select(Expression<Func<TEntity, bool>> whereClause = null, IOrderByClause<TEntity>[] orderBy = null, int skip = 0, int top = 0,
            string[] include = null)
        {
            IQueryable<TEntity> data = _internal.AsQueryable();

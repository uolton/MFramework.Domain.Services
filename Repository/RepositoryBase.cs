...
namespace MFramework.Domain.Services.Repository
{
        ...
        where TEntity : Entity<TEntity>,new()
    {
        ...
        {
            var strategy = MFrameworkServiceLocator
                .Current
        ...
        public abstract IEnumerable<TEntity> Select(Expression<Func<TEntity, bool>> whereClause = null, IOrderByClause<TEntity>[] orderBy = null, int skip = 0, int top = 0,
            string[] include = null);
    }
}

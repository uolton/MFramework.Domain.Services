...
using MFramework.Domain.Services.Repository;
using MFramework.Domain.Services.Transactions;
using MFramework.Domain.Services.Transactions.Impl;
using TransactionManager = MFramework.Domain.Services.Transactions.Impl.TransactionManager;

namespace MFramework.Domain.Services.Configuration
{
    ///<summary>
